...
- What are the levels for `subject_race`?
- What are the levels for `raw_Race`?
...
__q9__ Go deeper: Post at least one more question about the data and fit at least one more model in support of answering that question.
