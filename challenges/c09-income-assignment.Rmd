...
- Download the 5-year ACS estimates; save to your `data` folder and add the filename below.
...
__q4__ Convert the margin of error to standard error. Additionally, compute a 99% confidence interval on income, and compute the coefficient of variation `CV`. Provide these columns with the names `income_SE, income_lo, income_hi, income_CV`.
