...
There are four standard "C's" of <a href="https://en.wikipedia.org/wiki/Diamond_(gemstone)">judging</a>[judging] a diamond.[1] These are `carat, cut, color` and `clarity`, all of which are in the `diamonds` dataset.
