...
```{r q4-tests}
## NOTE: No need to change this!
assertthat::assert_that(assertthat::are_equal(V_q4, 31))
print("Well done!")
```
...
__q5__ Compute the mean and variance of $(X - 1) / 2$, where $\mathbb{E}[X] = 1$ and $\mathbb{V}[X] = 4$.
...
__q7__ (Bonus) Use the properties of the variance (used for q4 above) to  prove that $\mathbb{V}[\overline{X}] = \sigma^2 / n$, where $\overline{X} = \frac{1}{n}\sum_{i=1}^n X_i$, $\sigma^2 = \mathbb{V}[X]$, and the $X_i$ are mutually independent.
