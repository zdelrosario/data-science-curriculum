...
__q5__ Use your knowledge of regular expressions along with the `names_pattern` argument to successfully tidy the `alloys` data.
...
```{r q5-tests}
## NOTE: No need to change this!
assertthat::assert_that(dim(df_q5)[1] == 16)
assertthat::assert_that(dim(df_q5)[2] == 5)
print("Awesome!")
```
