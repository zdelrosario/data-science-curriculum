...
__q5__ Perform your *first checks* on `df_heart_disease`. Answer the questions below.

*Hint*: You may need to do some "deeper checks" to answer some of the questions below.

```{r q5-task}
# task-begin
## TODO: Perform your first checks on df_heart_disease
# task-end
# solution-begin
df_heart_disease %>% summary()
# solution-end
```
