...
```{r q1-vis, cache=TRUE, echo=FALSE}
diamonds %>%
  filter(carat <= 2) %>%
...
```{r q2-vis, cache=TRUE, echo=FALSE}
diamonds %>%
...
```{r q3-vis, cache=TRUE, echo=FALSE}
diamonds %>%
  pivot_longer(
...
__q4__ (Turn in all your answers via google forms. TODO: Add link!)
