...
One more note about functional relationships: Neither Pearson nor Spearman can pick up on arbitrary dependencies. *Bonus*: To see this fact, try changing the function above to a parabola `y = x^2` and re-running the chunks!
