...
__q1__ Use `vignette(package = ???)` to look up vignettes associated with
`"dplyr"`. What vignettes are available?
...
__q3__ Remember back to `e04-function-basics`; how do we look up help for a
specific function?
