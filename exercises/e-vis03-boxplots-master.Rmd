...
`geom_boxplot, geom_violin, geom_count, geom_tile & count, cut_interval, cut_number, cut_width, coord_flip`

Concept: Derive facts about data, then visualize those facts
