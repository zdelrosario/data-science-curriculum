...
**Your task**: Study the following graphs and determine where each example lies
on the narrative spectrum. Keep in mind your intended audience (your colleague)
...
at a higher carat, and improvement in `cut` tends to *increase* `price`.
...
`Premium` diamonds tend to overlap.
<!-- solution-end -->
...
__q4__ (Turn in all your answers via google forms)
